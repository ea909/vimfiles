...
hi Normal term=none ctermfg=White ctermbg=DarkBlue guifg=#FFE375 guibg=#101030
...
hi CursorLine term=underline cterm=none ctermbg=DarkGray guibg=#002646
hi CursorColumn term=reverse cterm=none ctermbg=DarkGray guibg=#002646
hi NonText term=bold cterm=bold ctermbg=Black ctermfg=Gray gui=bold guifg=grey50 guibg=#060620
hi EndOfBuffer term=none cterm=none ctermbg=Black ctermfg=Black gui=bold guifg=grey50 guibg=#060620
